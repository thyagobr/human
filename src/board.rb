...
class Board
  ...
  def fetch_by_coords(x, y)
    #@map[(x / Game::DEFAULT_TILE_SIZE) * (y / Game::DEFAULT_TILE_SIZE)]
    ...
    @map[local_x + (local_y * ((3 * Game::DEFAULT_WIDTH) / Game::DEFAULT_TILE_SIZE))]
  end
